...
function ipitledger_theme_scripts() {
	...
	wp_enqueue_script( 'ipitledger-theme-vendors', get_template_directory_uri() . "/assets/js/vendors.js", $version, true );
	if ( is_singular("services") ) {
		wp_enqueue_script( 'ipitledger-theme-virtual-select-js', get_template_directory_uri() . "/assets/js/virtual-select.js", $version, true );
	}

	wp_enqueue_script( 'ipitledger-theme-lottie', "https://cdnjs.cloudflare.com/ajax/libs/bodymovin/5.9.4/lottie.min.js", $version, true );

	if ( is_front_page() ) {
		wp_enqueue_script( 'ipitledger-theme-sliders', get_template_directory_uri() . "/assets/js/sliders.js", $version, true );
	}
